 <#
.SYNOPSIS
    Configures the "Interactive logon: Message title for users attempting to log on" policy to ensure a legal notice caption is displayed prior to logon.
...
try {
    Set-ItemProperty -Path "$RegHive$RegPath" -Name $ValueName -Value $DesiredValue -Type String
