<#
.SYNOPSIS
    Configures the "Minimum password length" policy to enforce a minimum password length of 14 characters.
...
.USAGE
    Run this script as an administrator to apply the necessary password policy changes.
    Example syntax:
